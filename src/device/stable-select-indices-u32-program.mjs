export const STABLE_SELECT_INDICES_U32_STATUS = Object.freeze({
  OK: 0,
  INVALID_EXTENT: 1,
...
function exclusiveFlagScanU32(flags, prefix, activeCount, inputCapacity, status) {
  ...
  if (ownFlag > gpu.u32(1)) gpu.atomic.cas(status, gpu.u32(0), gpu.u32(0), gpu.u32(3));
...
function selectIndicesFromScanU32(flags, prefix, outputIndices, outputCount, activeCount, inputCapacity, outputCapacity, status) {
  ...
  if (i === gpu.u32(0)) {
    ...
    if (selectedCount > outputCapacity) gpu.atomic.cas(status, gpu.u32(0), gpu.u32(0), gpu.u32(2));
  }

  if (selectedCount > outputCapacity || i >= active) return;
  if (flags[i] === gpu.u32(1)) outputIndices[prefix[i]] = i;
}
`;

export const stableSelectIndicesU32DeviceProgram = Object.freeze({
  source,
  compile: Object.freeze({ headerProfile: 'cuda-cccl' }),
  functions: Object.freeze([
    Object.freeze({
      name: 'resetControl', kind: 'kernel', returns: 'void',
    ...
    Object.freeze({
      name: 'exclusiveFlagScanU32', kind: 'kernel', returns: 'void',
      parameters: Object.freeze([
    ...
    Object.freeze({
      name: 'selectIndicesFromScanU32', kind: 'kernel', returns: 'void',
      parameters: Object.freeze([
        Object.freeze({ name: 'flags', type: 'ptr<u32>' }),
        Object.freeze({ name: 'prefix', type: 'ptr<u32>' }),
